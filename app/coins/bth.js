...
module.exports = {
	name:"Bithereum",
	ticker:"BTH",
	logoUrl:"/img/logo/bth.svg",
	siteTitle:"Bithereum Explorer",
	siteDescriptionHtml:"<b>BTH Explorer</b> is <a href='https://github.com/TheTrunk/btc-rpc-explorer). If you run your own [Bithereum Full Node](https://github.com/BTHPOS/BTH), **BTH Explorer** can easily run alongside it, communicating via RPC calls. See the project [ReadMe](https://github.com/TheTrunk/btc-rpc-explorer) for a list of features and instructions for running.",
	nodeTitle:"Bithereum Full Node",
